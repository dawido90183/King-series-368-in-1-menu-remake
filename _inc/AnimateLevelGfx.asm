...
.size		= 16	; number of tiles per frame
		...
		lea	(Art_GhzFlower1).l,a1 ;	load big flower	patterns
		lea	((v_128x128_end-$1000)&$FFFFFF).l,a2 ; load 2nd big flower from RAM
		move.b	(v_lani1_frame).w,d0
		addq.b	#1,(v_lani1_frame).w ; increment frame counter
...
.size		= 16	; number of tiles per frame
		...
		lea	((v_128x128_end-$1000+$400)&$FFFFFF).l,a1 ; load	special	flower patterns	(from RAM)
		lea	(a1,d0.w),a1	; jump to appropriate tile
		move.w	#.size-1,d1
		bra.w	LoadTiles
; ===========================================================================
...
.size		= 16	; number of tiles per frame
		...
		lea	((v_128x128_end-$1000+$A00)&$FFFFFF).l,a1 ; load	special	flower patterns	(from RAM)
		lea	(a1,d0.w),a1	; jump to appropriate tile
		move.w	#.size-1,d1
		bra.w	LoadTiles
; ===========================================================================
